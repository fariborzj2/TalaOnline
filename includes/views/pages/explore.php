<div class="section">
    <div class="d-flex-wrap gap-md align-stretch profile-container max-w-1000 mx-auto">
        <!-- Sidebar Navigation -->
        <div class="d-column basis-250 grow-1">
            <!-- stats info -->
            <div class="pd-md bg-block border radius-16 overflow-hidden sticky-card-2 mb-md">
                <div class="border-bottom d-flex just-between align-center mb-1 pb-1">
                    <strong class="d-flex align-center font-size-2 font-bold"><i data-lucide="bar-chart-2" class="icon-size-4 d-inline-block v-middle ml-05"></i>آمار کلی شبکه</strong>
                </div>
            ...
            <div class="bg-block pd-md border radius-16 sticky-card-2">
                <div class="border-bottom d-flex just-between align-center mb-1 pb-1">
                    <strong class="d-flex align-center font-size-2 font-bold m-0"><i data-lucide="users" class="icon-size-4 d-inline-block v-middle ml-05"></i>پیشنهاد برای دنبال کردن</strong>
                </div>
                    ...
                    <?php foreach ($suggested_users as $u): ?>
                        <a href="/profile/<?= $u['id'] ?>/<?= urlencode($u['username']) ?>" class="user-row">
                            ...
                            <div class="grow-1 line-height-2">
                                <div class="font-bold text-title font-size-1"><?= htmlspecialchars($u['name']) ?> <span class="d-flex align-center text-primary font-size-0-8"><i data-lucide="award" class="icon-size-2 v-middle"></i> <?= fa_num($u['level']) ?></span></div>
        ...
        <div class="basis-500 grow-9 overflow-hidden gap-md">
            <div class="py-1">
            ...
            <div id="explore-feed" class="min-h-400">
                <?php
