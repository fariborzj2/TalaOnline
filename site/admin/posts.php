                ...
                <tr class="hover:bg-slate-50/50 transition-colors group">
                    ...
                    <td class="text-center">
                        <div class="flex items-center justify-center gap-2">
                            <a href="post_edit.php?id=<?= $post['id'] ?>" class="w-8 h-8 bg-white border border-slate-100 text-slate-400 hover:text-indigo-600 hover:border-indigo-100 hover:bg-indigo-50 rounded-lg transition-all flex items-center justify-center group/btn" title="ویرایش" aria-label="ویرایش">
