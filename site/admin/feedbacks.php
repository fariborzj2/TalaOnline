...
check_permission("feedbacks.view");
                ...
                <tr class="hover:bg-slate-50/50 transition-colors group <?= !$fb['is_read'] ? 'bg-indigo-50/30' : '' ?>" data-id="<?= $fb['id'] ?>">
                    ...
                    <td class="text-center">
                        <div class="flex items-center justify-center gap-2">
                            <button class="w-8 h-8 bg-white border border-slate-100 text-slate-400 hover:text-indigo-600 hover:border-indigo-100 hover:bg-indigo-50 rounded-lg transition-all flex items-center justify-center group/btn" onclick='viewFeedback(<?= json_encode($fb) ?>)' title="مشاهده" aria-label="مشاهده">
