...
<head>
  ...
  <title><?= get_setting('site_title', 'طلا آنلاین') ?> | قیمت لحظه‌ای طلا، سکه و ارز</title>
                            ...
                            <div class="card-header d-flex just-between align-center mb-15">
                                <div class="d-flex align-center gap-10">
                                    <div class="asset-icon gold-icon">
                                        <img src="images/gold.svg" alt="طلای ۱۸ عیار">
                                    </div>
                                    <div>
                            ...
                            <div class="card-header d-flex just-between align-center mb-15">
                                <div class="d-flex align-center gap-10">
                                    <div class="asset-icon silver-icon">
                                        <img src="images/silver.svg" alt="نقره">
                                    </div>
                                    <div>
                ...
                <div class="block-card fade-in-up" style="animation-delay: 0.3s;">
                    <div class="d-flex-wrap just-between align-center mb-20 gap-15">
                        <div class="d-flex gap-10 align-center">
                            <div class="height-40 width-40 radius-100 border d-flex just-center align-center"><img src="images/road-wayside.svg" alt="مقایسه پلتفرم‌ها"></div>
                            <div>
